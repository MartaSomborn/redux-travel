...
const AdvancedFilter = () => {
  return (
    <>
      <h3 className="font-bold mt-8">Food</h3>
      ...
      <h3 className="font-bold">Hotel facility</h3>
      ...
      <h3 className="font-bold">Distance from the sea</h3>
      ...
      <FormControlLabel control={<Checkbox />} label={" > 5 km"} />
      <h3 className="font-bold">Distance from the city</h3>
      <FormControlLabel control={<Checkbox />} label={"1 km"} />
      <FormControlLabel control={<Checkbox />} label={"2 km"} />
      <FormControlLabel control={<Checkbox />} label={"5 km"} />
      <FormControlLabel control={<Checkbox />} label={" > 5 km"} />
